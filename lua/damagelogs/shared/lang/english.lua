DamagelogLang.english = {
  ...
  OpenChat = "Open chat",
  JoinChat = "Join chat",
  RDMDeathScene = "View Death Scene",
  ...
  HasAnsweredReport = "has answered to the report",
  HasCanceledReport = "has canceled the report.",
  ...
  YouCancelReport = "decided to forgive you.",
  YouKeepReport = "decided not to forgive you.",
  NoMercyForYou = "does not want to forgive you.",
  ...
  -- Weapons
  WeaponMac10 = "a Mac10",
  WeaponFlare = "a flare gun",
  WeaponGlock = "a glock",
  WeaponM16 = "an M16",
  WeaponKnife = "a knife",
  WeaponDeagle = "a deagle",
  WeaponRifle = "a rifle",
  WeaponShotgun = "a shotgun",
  WeaponHUGE = "a HUGE",
  WeaponUMP = "an UMP Prototype",
  WeaponCrowbar = "a crowbar",
  WeaponPistol = "a pistol",
  WeaponNewtonLauncher = "a Newton Launcher",
  WeaponVisualizer = "a Visualizer",
  WeaponDecoy = "a Decoy",
  WeaponDefuser = "a Defuser",
  WeaponHealthStation = "a Health Station",
  WeaponTeleporter = "a teleporter",
  WeaponPoltergeist = "a poltergeist",
  WeaponIncendiaryGrenade = "an incendiary grenade",
  WeaponSmokeGrenade = "a smoke grenade",
  WeaponDiscombobulator = "a Discombobulator",
  WeaponSilencedPistol = "a silenced pistol",
  WeaponC4 = "C4",
  WeaponCarry = "Magneto-stick",
  WeaponRadio = "a radio",
  WeaponBinoculars = "binoculars",
