...
function event:IsAllowed(tbl)
	if (tbl[1] == 1 or tbl[1] == 3) and not Damagelog.filter_settings["filter_show_disguises"] 
    or tbl[1] == 2 and not Damagelog.filter_settings["filter_show_teleports"] 
    or tbl[1] == 4 and not Damagelog.filter_settings["filter_show_traps"]
    or tbl[1] == 5 and not Damagelog.filter_settings["filter_show_psroles"] 
    then 
        return false 
    end
