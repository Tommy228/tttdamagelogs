...
net.Receive("DL_SendChatMessage", function(_, ply)
	local id = net.ReadUInt(32)
...
net.Receive("DL_AddChatPlayer", function(_, ply)
	local id = net.ReadUInt(32)
...
net.Receive("DL_CloseChat", function(_, ply)
	local id = net.ReadUInt(32)
	local to_add = net.ReadEntity()
...
net.Receive("DL_LeaveChat", function(_, ply)
	local id = net.ReadUInt(32)
...
net.Receive("DL_ForceStay", function(_, ply)
	local id = net.ReadUInt(32)
...
net.Receive("DL_ViewChat", function(_, ply)
	local id = net.ReadUInt(32)
